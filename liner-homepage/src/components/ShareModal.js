...
function ShareModal({ link, isOpen, setIsOpen, title, description }) {
  useEffect(() => {
    if (isOpen) {
      // 스크롤 방지
            ...
            <div className="modal-txt">
              ...
              <div className="share-body">
                ...
                <div className="modal-list-container">
                  <a
                    className="share-sns fb modal-list"
                  ...
                  <a
                    className="share-sns twitter modal-list"
                  ...
                  <a
                    className="share-sns in modal-list"
                  ...
                  <a
                    className="share-sns fbm modal-list"
                  ...
                  <a
                    className="share-sns line modal-list"
                  ...
                  <a
                    className="share-sns mail modal-list"
